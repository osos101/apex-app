...
,p_release=>'24.2.0'
,p_default_workspace_id=>52533632827119673717
,p_default_application_id=>193387
,p_default_id_offset=>2007510983248937224
,p_default_owner=>'WKSP_OOSAA'
);
end;
/
 
prompt APPLICATION 193387 - Sample Calendar
--
-- Application Export:
--   Application:     193387
--   Name:            Sample Calendar
--   Date and Time:   10:57 Sunday January 19, 2025
--   Exported By:     YOUSSIFOSAMA.DSC@GMAIL.COM
--   Flashback:       0
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_OOSAA')
...
,p_application_group=>wwv_flow_imp.id(61572487251430603087)
...
,p_authentication_id=>wwv_flow_imp.id(10210745333400630547)
...
wwv_flow_imp_shared.create_user_interface(
 p_id=>wwv_flow_imp.id(193387)
,p_theme_id=>42
,p_home_url=>'f?p=&APP_ID.:1:&SESSION.'
,p_theme_style_by_user_pref=>true
,p_navigation_list_id=>wwv_flow_imp.id(3714525848270843757)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:js-defaultCollapsed:js-navCollapsed--hidden:t-TreeNav--styleA'
,p_css_file_urls=>'#IMAGE_PREFIX#pkgapp_ui/css/5.0#MIN#.css'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(3714540433751953109)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2799637439289884001)
,p_name=>'Standard Calendars'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799637671452884002)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799638091203884003)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799638419220884003)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799638906294884003)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799639255257884004)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2637700993467549752)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2799642653155936828)
,p_name=>'Calendars and Dynamic Actions'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799642861532936829)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799643265389936829)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799643639136936829)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799678482167305629)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2988208936114398284)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2799647817013994832)
,p_name=>'Calendars and Javascript'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799648023932994833)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799648464065994834)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799648834359994834)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2803746445768223771)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2799653457245040030)
,p_name=>'Calendar Styling'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799653699472040030)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799654025950040031)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2857428741741246646)
,p_name=>'Custom Calendar Initialization'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2857428939343246647)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3714525848270843757)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795679343127473864)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795749116392755027)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'Monthly Calendar: Projects'
,p_list_item_link_target=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(2795679343127473864)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2786366577081022245)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2792959095476310563)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795685498987493504)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799568806555251546)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2626483145953553568)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795691347544535902)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795697059012547974)
,p_list_item_display_sequence=>140
,p_list_item_link_text=>'Calendar and Report'
,p_list_item_link_target=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(2795691347544535902)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'51'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795710432558561721)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795725703774641199)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799670684141260314)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2901330916234316307)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795749708832781338)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795750512928805989)
,p_list_item_display_sequence=>190
,p_list_item_link_text=>'Custom Navigation'
,p_list_item_link_target=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(2795749708832781338)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'71'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795777025043998092)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795877890130171616)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2803701593954673750)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2857426626954233302)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2857413062738109414)
,p_list_item_display_sequence=>300
,p_list_item_link_text=>'Weekly schedule'
,p_list_item_link_target=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(2857426626954233302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'111'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795847941014857501)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795848752299865279)
,p_list_item_display_sequence=>230
,p_list_item_link_text=>'Custom CSS Classes'
,p_list_item_link_target=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(2795847941014857501)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'91'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2795855577612952184)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3717746260659345199)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3714540433751953109)
,p_name=>'Navigation Bar (Top)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3714540615202953111)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3714541010551953205)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3714541402419953205)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Sign Out'
,p_list_item_link_target=>'&LOGOUT_URL.'
,p_parent_list_item_id=>wwv_flow_imp.id(3714541010551953205)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3879872792064593087)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3879873111115593090)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3879873460539593091)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(4593206116699429623)
,p_name=>'Home Page List'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5428258105158965190)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Standard Calendars'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-calendar'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5425026321306405123)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5425026336134405123)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5425026473283405123)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Calendar Styling'
,p_list_item_link_target=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-paint-brush'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2799607426821574610)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(2547770217181967662)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(2547770351421967672)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(2547770648234967709)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2017309510752996080)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>186626129
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2018830714201515395)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2018860392693476742)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>37167665069464
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2018860814668476743)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2018883547203322358)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2117155069981884976)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2138707482418375858)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2140524284074474538)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2193439888592502892)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2624093482736704621)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37166093867981
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3138539008993502610)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3784902864084387480)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3851603005150669580)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3937518006928615626)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(5216839712012264857)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(5216839107510263530)
,p_icon_sequence=>20
,p_icon_subtext=>'Help'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(10210744844718630545)
,p_icon_sequence=>30
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(3572740616854619611)
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(5182791690727715950)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(4589512521042844182)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2795674915528450420)
,p_lov_name=>'SESSION_TYPES'
,p_lov_query=>'.'||wwv_flow_imp.id(2795674915528450420)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2795675279039450420)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Business'
,p_lov_return_value=>'BUSINESS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2795675618404450422)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Technical'
,p_lov_return_value=>'TECHNICAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2795676030745450422)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'General Session'
,p_lov_return_value=>'GENERAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2795676489599450422)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Break'
,p_lov_return_value=>'BREAK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2795676871847450423)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2340272716587563659)
,p_lov_name=>'STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(2340272716587563659)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2340272950297563660)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Active'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2340273435258563660)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(4668567803146216733)
,p_lov_name=>'VALID STATUS CODES'
,p_lov_query=>'.'||wwv_flow_imp.id(4668567803146216733)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4668568010891216736)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Closed'
,p_lov_return_value=>'Closed'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4668568195602216744)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'On-Hold'
,p_lov_return_value=>'On-Hold'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4668568391165216744)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Open'
,p_lov_return_value=>'Open'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4668568600869216744)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(10210746634251630557)
,p_name=>' Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2626485210432553616)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
,p_short_name=>'Faceted Search: Projects'
,p_link=>'f?p=&APP_ID.:36:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>36
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799620303587666159)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799620540161678004)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799620741499680047)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799620948239681751)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799621126743682916)
,p_parent_id=>wwv_flow_imp.id(2799641807611916757)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799621378588686769)
,p_parent_id=>wwv_flow_imp.id(2799646855689979885)
,p_short_name=>'Calendar and Report'
,p_link=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.:::'
,p_page_id=>51
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799621548735688531)
,p_parent_id=>wwv_flow_imp.id(2799646855689979885)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799621774672690696)
,p_parent_id=>wwv_flow_imp.id(2799646855689979885)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799621972808693019)
,p_parent_id=>wwv_flow_imp.id(2799652996710030486)
,p_short_name=>'Custom Navigation'
,p_link=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.:::'
,p_page_id=>71
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799622127985695219)
,p_parent_id=>wwv_flow_imp.id(2799652996710030486)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799622393721696341)
,p_parent_id=>wwv_flow_imp.id(2799652996710030486)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799622522124698679)
,p_parent_id=>wwv_flow_imp.id(2799657020846062563)
,p_short_name=>'Custom CSS Classes'
,p_link=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.:::'
,p_page_id=>91
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2799622761767700355)
,p_parent_id=>wwv_flow_imp.id(2799657020846062563)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2834831886364626573)
,p_parent_id=>wwv_flow_imp.id(2799646855689979885)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2857431374651268141)
,p_short_name=>'Custom Calendar Initialization'
,p_link=>'f?p=&APP_ID.:110:&SESSION.::&DEBUG.:::'
,p_page_id=>110
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2857431607796271406)
,p_parent_id=>wwv_flow_imp.id(2857431374651268141)
,p_short_name=>'Custom weekly schedule'
,p_link=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.:::'
,p_page_id=>111
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2902522212948370158)
,p_parent_id=>wwv_flow_imp.id(2799652996710030486)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3320549218492351674)
,p_short_name=>'Mini Calendar'
,p_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::'
,p_page_id=>13
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3320549891655351678)
,p_parent_id=>wwv_flow_imp.id(3320549218492351674)
,p_short_name=>'&P14_PROJECT.'
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3879391047856108834)
,p_parent_id=>wwv_flow_imp.id(3879872530796593083)
,p_short_name=>'Application Theme Style'
,p_link=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::'
,p_page_id=>8
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3879872530796593083)
,p_short_name=>'Administration'
,p_link=>'f?p=&APP_ID.:15:&SESSION.'
,p_page_id=>15
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4587695419064594469)
,p_short_name=>'Calendar Entry'
,p_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::'
,p_page_id=>3
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4588104095596678010)
,p_short_name=>'Time Line'
,p_link=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4600827098152516810)
,p_parent_id=>wwv_flow_imp.id(3879872530796593083)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4602438799845736730)
,p_parent_id=>wwv_flow_imp.id(4600827098152516810)
,p_short_name=>'Report'
,p_link=>'f?p=&APP_ID.:7:&SESSION.'
,p_page_id=>7
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4668163192779153750)
,p_short_name=>'Project Due Dates'
,p_link=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:::'
,p_page_id=>9
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4668163522455153751)
,p_parent_id=>wwv_flow_imp.id(4668163192779153750)
,p_short_name=>'Project Detail'
,p_link=>'f?p=&FLOW_ID.:10:&SESSION.'
,p_page_id=>10
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(5257616009990664374)
,p_short_name=>'Help'
,p_link=>'f?p=&FLOW_ID.:12:&SESSION.'
,p_page_id=>12
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(10210747046099630560)
,p_short_name=>'Home'
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5181730494923135103)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160021616168337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160021659718337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160021766625337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160021868770337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160021989926337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022093592337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022241186337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022338151337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022344242337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022478307337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022545194337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022715695337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2160022822985337641)
,p_plug_template_id=>wwv_flow_imp.id(5181730494923135103)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(3714482909294722664)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(3714448208944722547)
,p_default_footer_template=>wwv_flow_imp.id(3714448208944722547)
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035176584257334310)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035180559710334312)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035182599034334313)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035185800961334315)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035194131037334321)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
,p_display_name=>'Display Mode'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035204053614334327)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2035208065675334330)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987935184014675152)
,p_theme_id=>142
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987935500849675152)
,p_theme_id=>142
,p_name=>'DISPLAY_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987937350585675157)
,p_theme_id=>142
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987937712848675157)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987939507365675160)
,p_theme_id=>142
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987939968666675160)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987940230884675161)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987941369592675161)
,p_theme_id=>142
,p_name=>'REGION_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987942348611675162)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987943021103675163)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987943360795675163)
,p_theme_id=>142
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987945414238675168)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987945873136675168)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987946174044675168)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987947588806675171)
,p_theme_id=>142
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987948507152675173)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987949930365675174)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987951069091675175)
,p_theme_id=>142
,p_name=>'ICON_STYLE'
,p_display_name=>'Icon Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987952915038675180)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987954022530675182)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987954752363675184)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987956041060675187)
,p_theme_id=>142
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987956373422675187)
,p_theme_id=>142
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987956703480675187)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987957054719675187)
,p_theme_id=>142
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987957345799675187)
,p_theme_id=>142
,p_name=>'BUTTON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987957884695675187)
,p_theme_id=>142
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987958621742675187)
,p_theme_id=>142
,p_name=>'BUTTON_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987959139140675188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987959660227675188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987959923894675188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987960266678675188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2987960580421675188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3052068235475035081)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3074821366946117822)
,p_theme_id=>142
,p_name=>'CURRENT_PAGE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3234030341913689806)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3234036139545689818)
,p_theme_id=>142
,p_name=>'LIST_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3270882130604917691)
,p_theme_id=>142
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3270884557567917693)
,p_theme_id=>142
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3270903674267917718)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3357658471043939599)
,p_theme_id=>142
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3361185617278296973)
,p_theme_id=>142
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3537434724431386269)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(5182791201069690537)
,p_name=>'ADMINISTRATION'
,p_message_text=>'Administration'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(4585476418254341847)
,p_name=>'HELP'
,p_message_text=>'Help'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(4585468416177341227)
,p_name=>'LOGOUT'
,p_message_text=>'Logout'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(4693559916346817764)
,p_name=>'USER'
,p_message_text=>'User'
,p_version_scn=>37166093867993
);
...
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(4668156601263153708)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(10210745333400630547)
,p_name=>'APEX Auth'
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3316844115733004407)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031217110097000889)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031217338238000894)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031217771311000894)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031218136255000894)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031218590947000895)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031218954641000895)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031219369649000895)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031219749523000895)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031220169915000896)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031220535606000896)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6031221005911000897)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(6031221916976000920)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(6031222690205000928)
,p_plugin_id=>wwv_flow_imp.id(3316844115733004407)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3337557600292579771)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2626175470591315242)
,p_plugin_id=>wwv_flow_imp.id(3337557600292579771)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2626175893461315243)
,p_plugin_id=>wwv_flow_imp.id(3337557600292579771)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3474135491606750565)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2179957946394873696)
,p_plugin_id=>wwv_flow_imp.id(3474135491606750565)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2179958359835873696)
,p_plugin_id=>wwv_flow_imp.id(3474135491606750565)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(2179959643430873697)
,p_plugin_id=>wwv_flow_imp.id(3474135491606750565)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2179960414666873700)
,p_plugin_id=>wwv_flow_imp.id(3474135491606750565)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3678580028568997873)
,p_plugin_type=>'REGION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3729889864408598822)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158798171161804251)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158798560912804252)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158799026517804252)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158799426474804252)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158799797705804252)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158800145409804252)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158800548404804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158801027950804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158801369995804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158801820325804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158802147670804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158802578320804253)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2158802963817804254)
,p_plugin_attribute_id=>wwv_flow_imp.id(2158802578320804253)
,p_display_sequence=>10
,p_display_value=>'Timeline'
,p_return_value=>'D'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2158803446793804254)
,p_plugin_attribute_id=>wwv_flow_imp.id(2158802578320804253)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158803947647804254)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158804404817804254)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(2158798560912804252)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NOT_NULL'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2158804753269804255)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(2158806055575804256)
,p_plugin_id=>wwv_flow_imp.id(3729889864408598822)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3314815490810355285)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3678580238705003621)
,p_plug_name=>'Footer'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4140620627486447414)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4593207211325429627)
...
,p_list_id=>wwv_flow_imp.id(4593206116699429623)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799598744567477814)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4587690509944594431)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2799598744567477814)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5296949208090666959)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4587690693148594431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3642714327524060658)
,p_name=>'P3_LASTVIEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4587691113140594438)
,p_name=>'P3_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4587691292996594449)
,p_name=>'P3_TASK_NAME'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4587691517715594452)
,p_name=>'P3_END_DATE'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4602286196208719972)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5296948202130409769)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5296950622906765832)
,p_name=>'P3_PROJECT'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5296951405207808091)
,p_name=>'P3_STATUS'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(4587690296619594430)
...
,p_lov=>'.'||wwv_flow_imp.id(4668567803146216733)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3909012183082135058)
...
,p_associated_item=>wwv_flow_imp.id(4587691517715594452)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5294236900652277007)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5294237190857277027)
,p_event_id=>wwv_flow_imp.id(5294236900652277007)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4587692118299594455)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4587692308910594456)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2799598827224477815)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3316879616870988380)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3642712400317060638)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642712509243060639)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642712528879060640)
,p_name=>'THE_LINK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642712711854060642)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713102437060645)
,p_name=>'COST'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COST'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713178611060646)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713600299060650)
,p_name=>'PROJECT'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'PROJECT'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713698465060651)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'STATUS'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713742096060652)
,p_name=>'ASSIGNED_TO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3642713877249060653)
,p_name=>'COLOR'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COLOR'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4588103817413678010)
...
,p_plug_display_sequence=>50
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(10210746634251630557)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4594592208931616569)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4598303093103094544)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4588103817413678010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4594592393351616571)
,p_name=>'P4_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4594592208931616569)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4600826822954516809)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5188941214936808611)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4143813328961499924)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_imp.id(5188941214936808611)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4602822097341777122)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4143813328961499924)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4600892993458520454)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4143813328961499924)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5290334105561001889)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(4143813328961499924)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(4600951710773525449)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4600912998652522014)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(4600892993458520454)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4602438496163736727)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4602438908542736730)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4602438990851736730)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439200406736734)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439299103736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439395253736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439493979736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439617465736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439707838736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439813379736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602439895367736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602440017132736736)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4602440102588736736)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4602448021966736891)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4602902617080782812)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4602438908542736730)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(2671079215293132413)
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_help_text=>'No help is available for this page.'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879386830084108830)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879387231386108830)
,p_plug_name=>'About this page'
,p_parent_plug_id=>wwv_flow_imp.id(3879386830084108830)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879387642908108831)
,p_plug_name=>'items'
,p_parent_plug_id=>wwv_flow_imp.id(3879386830084108830)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879390661460108834)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3879388837278108832)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3879390661460108834)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3879389255160108833)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3879390661460108834)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3879391730719108837)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3879389255160108833)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2988199082466315116)
,p_name=>'P8_ENABLE_USER_STYLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3879387642908108831)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3879388071907108831)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3879391218423108835)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3879389255160108833)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3316884603421088563)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4204247000178953421)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3337565699786671197)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(4204247000178953421)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4668161291683153739)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4668161506402153740)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668161602107153746)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668161692365153747)
,p_db_column_name=>'ROW_VERSION_NUMBER'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Row Version Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668161817848153747)
,p_db_column_name=>'PROJECT'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668161904857153748)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668161999295153748)
,p_db_column_name=>'START_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668162114747153748)
,p_db_column_name=>'END_DATE'
,p_display_order=>6
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668162213119153749)
,p_db_column_name=>'STATUS'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668162302712153749)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668162404760153749)
,p_db_column_name=>'COST'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668162504081153749)
,p_db_column_name=>'BUDGET'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668243503183169411)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4668243614594169412)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4668167515388153970)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4668162817815153750)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668414405177188880)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4668162817815153750)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668162722945153749)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4668162817815153750)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3642714117181060656)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4668155797052153700)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668156222333153701)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3642714117181060656)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668156119733153701)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3642714117181060656)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668155996316153701)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(3642714117181060656)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4668156401383153701)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3642714117181060656)
,p_button_name=>'CANCEL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(4668157321941153714)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668157494863153715)
,p_name=>'P10_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668157711529153717)
,p_name=>'P10_PROJECT'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668157921245153718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668158106591153719)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668158312920153719)
,p_name=>'P10_END_DATE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668158519289153719)
,p_name=>'P10_STATUS'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668158720933153719)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668158922121153719)
,p_name=>'P10_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4668159094540153721)
,p_name=>'P10_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(4668155797052153700)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2246334262864039528)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(4668156401383153701)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2246334382943039529)
,p_event_id=>wwv_flow_imp.id(2246334262864039528)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4668160301205153728)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4668160498399153730)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4668160721223153731)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(4668156222333153701)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(4066140716583124742)
,p_name=>'&APP_NAME.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4066140888150124743)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4066141004782124744)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4066141047463124745)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257614199679664361)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257614592473664365)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_imp.id(5257614199679664361)
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257614820975664370)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257614999306664370)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_imp.id(5257614199679664361)
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257615613313664372)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3320547797509351668)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3320548010916351668)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548118140351671)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548216847351673)
,p_db_column_name=>'PROJECT'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548322877351673)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548405095351673)
,p_db_column_name=>'START_DATE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548507753351673)
,p_db_column_name=>'END_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'End Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548622847351673)
,p_db_column_name=>'STATUS'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548714173351674)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548809361351674)
,p_db_column_name=>'COST'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3320548899207351674)
,p_db_column_name=>'BUDGET'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3320556114164353299)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3320549404205351677)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3320889702399425589)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3321187196259480614)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3320547797509351668)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3320543002996351644)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3320549710188351677)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321213418862543886)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3474139305180759454)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3474139492672765240)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3320543517871351645)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3320549710188351677)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3320543821077351645)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320543992600351646)
,p_name=>'P14_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3321213418862543886)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320544216939351656)
,p_name=>'P14_PROJECT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3320543002996351644)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Project'
,p_source=>'PROJECT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320544407977351656)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320544611096351656)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320544819877351657)
,p_name=>'P14_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3320543002996351644)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320545000076351657)
,p_name=>'P14_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3320543002996351644)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320545207672351657)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320545407543351657)
,p_name=>'P14_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3320543002996351644)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3320545594465351658)
,p_name=>'P14_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3320543002996351644)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3320546990944351660)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3320547195362351660)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3320546812558351659)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879870927949593074)
...
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(3879872792064593087)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3879872168331593082)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600454055477831)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4659686945844788728)
,p_plug_name=>'Standard Calendars'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(2799637439289884001)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599196690477818)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4493681627185472421)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4493682758995472427)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4493684730417472511)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795744776411744005)
,p_name=>'P31_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4493684730417472511)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795746901672744008)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795747376676744009)
,p_event_id=>wwv_flow_imp.id(2795746901672744008)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4493682758995472427)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799598981310477816)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4493682758995472427)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799599055771477817)
,p_event_id=>wwv_flow_imp.id(2799598981310477816)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599243990477819)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4484304666883750651)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4484305798693750657)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2786370181182022304)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2786370644161022309)
,p_event_id=>wwv_flow_imp.id(2786370181182022304)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4484305798693750657)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2785879285011168940)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599376912477820)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257443469268385801)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5257444601078385807)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2785879320613168941)
,p_name=>'P33_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2785879285011168940)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785879022040168938)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5257444601078385807)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785879159984168939)
,p_event_id=>wwv_flow_imp.id(2785879022040168938)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5257444601078385807)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785879499336168942)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785879588020168943)
,p_event_id=>wwv_flow_imp.id(2785879499336168942)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599420432477821)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3561744511287987004)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6033308695545203865)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6033309827355203871)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795686789739493508)
,p_name=>'P34_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3561744511287987004)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795687998704493510)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6033309827355203871)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795688481612493511)
,p_event_id=>wwv_flow_imp.id(2795687998704493510)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6033309827355203871)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795688838757493512)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795689407567493512)
,p_event_id=>wwv_flow_imp.id(2795688838757493512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2795758852707815258)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2795758980824815259)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599564827477822)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4341493097158563119)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6813057281415779980)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6813058413225779986)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795759019252815260)
,p_name=>'P35_SHOW_TIME_FORMAT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4341493097158563119)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2799570010475251593)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799572056644251629)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799572587552251630)
,p_event_id=>wwv_flow_imp.id(2799572056644251629)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6813058413225779986)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2626487828786555672)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(5102856676211029881)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3408773113906035272)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5102855544401029875)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5102856676211029881)
,p_plug_name=>'Tasks'
,p_region_name=>'task_due_dates'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2626487913325555673)
,p_name=>'P36_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2626487828786555672)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2626488031000555674)
,p_name=>'P36_PROJECT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2626485354565553619)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2626485854668553621)
,p_event_id=>wwv_flow_imp.id(2626485354565553619)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5102856676211029881)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2626486249368553622)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5102856676211029881)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2626486800243553622)
,p_event_id=>wwv_flow_imp.id(2626486249368553622)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600540514477832)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5439511920534082797)
,p_plug_name=>'Calendars and Dynamic Actions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(2799642653155936828)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599615665477823)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5259698427223788650)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5259699559033788656)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3561753562477041471)
,p_name=>'Tasks '
,p_parent_plug_id=>wwv_flow_imp.id(5259699559033788656)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795699413907547986)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795699824054547986)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795700223259547986)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795700658405547987)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795701022386547991)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795701491245547992)
,p_query_column_id=>6
,p_column_alias=>'COST'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795701868965547992)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795702211993547992)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2795699031326547984)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5259701530455788740)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795697731968547980)
,p_name=>'P51_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5259701530455788740)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795702617888547993)
,p_name=>'P51_CAL_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3561753562477041471)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795703067446547993)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795704229181547994)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795704760999547995)
,p_event_id=>wwv_flow_imp.id(2795704229181547994)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5259699559033788656)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795705279783547995)
,p_event_id=>wwv_flow_imp.id(2795704229181547994)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3561753562477041471)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795705645370547995)
,p_name=>'Calendar View Changed: Refresh Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5259699559033788656)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795706199964548004)
,p_event_id=>wwv_flow_imp.id(2795705645370547995)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795707170430548016)
,p_event_id=>wwv_flow_imp.id(2795705645370547995)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795706689695548004)
,p_event_id=>wwv_flow_imp.id(2795705645370547995)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795707546623548017)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795708070602548017)
,p_event_id=>wwv_flow_imp.id(2795707546623548017)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795708571912548018)
,p_event_id=>wwv_flow_imp.id(2795707546623548017)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795709013763548018)
,p_event_id=>wwv_flow_imp.id(2795707546623548017)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599723678477824)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3561769485257055243)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6033333669514272104)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6033334801324272110)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2785880205672168949)
,p_name=>'P52_ENDDATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3561769485257055243)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2785880279570168950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795711767960561723)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795712958536561725)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6033334801324272110)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795713412635561726)
,p_event_id=>wwv_flow_imp.id(2795712958536561725)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6033334801324272110)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795713838352561727)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795714399532561727)
,p_event_id=>wwv_flow_imp.id(2795713838352561727)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785880006509168947)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785880030130168948)
,p_event_id=>wwv_flow_imp.id(2785880006509168947)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785880400667168951)
,p_event_id=>wwv_flow_imp.id(2785880006509168947)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785880575838168953)
,p_event_id=>wwv_flow_imp.id(2785880006509168947)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785880614951168954)
,p_event_id=>wwv_flow_imp.id(2785880006509168947)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599858081477825)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4337674954114021025)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6809239138371237886)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6809240270181237892)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2785880981529168957)
,p_name=>'P53_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4337674954114021025)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795726919227641203)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795729888570641206)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795730321786641206)
,p_event_id=>wwv_flow_imp.id(2795729888570641206)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6809240270181237892)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785880803316168955)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6809240270181237892)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785880847098168956)
,p_event_id=>wwv_flow_imp.id(2785880803316168955)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785881081837168958)
,p_event_id=>wwv_flow_imp.id(2785880803316168955)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785881156004168959)
,p_event_id=>wwv_flow_imp.id(2785880803316168955)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785881278524168960)
,p_event_id=>wwv_flow_imp.id(2785880803316168955)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600918314477836)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5117525413018605919)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7589089597275822780)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7589090729085822786)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2799672232653260318)
,p_name=>'P54_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5117525413018605919)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2799672631837260327)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799673296547260328)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799673727447260332)
,p_event_id=>wwv_flow_imp.id(2799673296547260328)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(7589090729085822786)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799674117168260333)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7589090729085822786)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799676169031260335)
,p_event_id=>wwv_flow_imp.id(2799674117168260333)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799675113862260334)
,p_event_id=>wwv_flow_imp.id(2799674117168260333)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799675620400260334)
,p_event_id=>wwv_flow_imp.id(2799674117168260333)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600694057477833)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6219342238472430095)
,p_plug_name=>'Calendars and Javascript'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(2799647817013994832)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799599930179477826)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5269611989873602991)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5269613121683602997)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5269615093105603081)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2795758555215815255)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_button_name=>'TODAY'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2785881370560168961)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_button_name=>'NEXT'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2795754601677815215)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_button_name=>'PREV'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795751835045805991)
,p_name=>'P71_PROJECTS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795755091892815220)
,p_name=>'P71_GOTODATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_prompt=>'Goto date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795756619609815236)
,p_name=>'P71_VIEWTYPE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(5269615093105603081)
,p_prompt=>'View Type'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795753015154805993)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795753585901805993)
,p_event_id=>wwv_flow_imp.id(2795753015154805993)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5269613121683602997)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785881505038168962)
,p_name=>'Calendar: Next Month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2785881370560168961)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795754373792815213)
,p_event_id=>wwv_flow_imp.id(2785881505038168962)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795754904398815218)
,p_name=>'Calendar: Prev Month'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2795754601677815215)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795754981437815219)
,p_event_id=>wwv_flow_imp.id(2795754904398815218)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795755131603815221)
,p_name=>'Focus Date'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795755216299815222)
,p_event_id=>wwv_flow_imp.id(2795755131603815221)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795755548428815225)
,p_event_id=>wwv_flow_imp.id(2795755131603815221)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795756754403815237)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795756895450815238)
,p_event_id=>wwv_flow_imp.id(2795756754403815237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795756938867815239)
,p_name=>'Change View'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795757031410815240)
,p_event_id=>wwv_flow_imp.id(2795756938867815239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795758703956815256)
,p_name=>'Set Goto Date to "today"'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2795758555215815255)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795758750726815257)
,p_event_id=>wwv_flow_imp.id(2795758703956815256)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600091457477827)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6045568851823925665)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6045569983633925671)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6045571955055925755)
,p_plug_name=>'Button Bar'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795755634152815226)
,p_name=>'P72_END_DATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(6045571955055925755)
,p_prompt=>'to'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795755728655815227)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795779141950998094)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795780742894998097)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795781297871998098)
,p_event_id=>wwv_flow_imp.id(2795780742894998097)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6045569983633925671)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795781707649998098)
,p_name=>'Calendar: Next Month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2785881370560168961)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795782206404998099)
,p_event_id=>wwv_flow_imp.id(2795781707649998098)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795755866863815228)
,p_name=>'Get Calendar Status'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6045569983633925671)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795755913054815229)
,p_event_id=>wwv_flow_imp.id(2795755866863815228)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795756046134815230)
,p_event_id=>wwv_flow_imp.id(2795755866863815228)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795756158470815231)
,p_event_id=>wwv_flow_imp.id(2795755866863815228)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799598663716477813)
,p_event_id=>wwv_flow_imp.id(2795755866863815228)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600206504477828)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4337827171719551440)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6809391355976768301)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6809392487786768307)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2795757424223815244)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4337827171719551440)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2795757999596815249)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4337827171719551440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795757370052815243)
,p_name=>'P73_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4337827171719551440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795757873277815248)
...
,p_lov=>'.'||wwv_flow_imp.id(2795674915528450420)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795879588943171626)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2795879977798171626)
,p_name=>'P73_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(4337827171719551440)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795882928168171630)
,p_name=>'Date Range Selected: Create new Event'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6809392487786768307)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendardateselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795883416566171630)
,p_event_id=>wwv_flow_imp.id(2795882928168171630)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795883991373171631)
,p_event_id=>wwv_flow_imp.id(2795882928168171630)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795757802386815247)
,p_event_id=>wwv_flow_imp.id(2795882928168171630)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
,p_affected_button_id=>wwv_flow_imp.id(2795757424223815244)
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795757589474815245)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2795757424223815244)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795757694681815246)
,p_event_id=>wwv_flow_imp.id(2795757589474815245)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795758027575815250)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2795757999596815249)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795758168354815251)
,p_event_id=>wwv_flow_imp.id(2795758027575815250)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795758284928815252)
,p_event_id=>wwv_flow_imp.id(2795758027575815250)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6809392487786768307)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795758317814815253)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795758470639815254)
,p_event_id=>wwv_flow_imp.id(2795758317814815253)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799601051570477837)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2902521840128370148)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5121708545716549725)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7593272729973766586)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7593273861783766592)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2803703122149673788)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5121708545716549725)
,p_button_name=>'SHOW_IN_CALENDAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2803703512521673790)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5121708545716549725)
,p_button_name=>'SAVE_IN_DATABASE'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2803751113802282414)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(5121708545716549725)
,p_button_name=>'CLEAR'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2799601358025477840)
,p_name=>'P74_MY_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2799601051570477837)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2803703943077673790)
,p_name=>'P74_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5121708545716549725)
,p_item_default=>'My Session'
,p_prompt=>'Title'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2803704724821673798)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2803705182415673799)
,p_name=>'P74_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(5121708545716549725)
,p_item_default=>'to_char(sysdate, ''YYYY-MM-DD'')||'' 11:00:00'''
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2803710875470673846)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2803703122149673788)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803711408593673846)
,p_event_id=>wwv_flow_imp.id(2803710875470673846)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2803705755721673831)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2803703512521673790)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803706269122673835)
,p_event_id=>wwv_flow_imp.id(2803705755721673831)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803706780115673840)
,p_event_id=>wwv_flow_imp.id(2803705755721673831)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2799601051570477837)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2988199187679315117)
,p_event_id=>wwv_flow_imp.id(2803705755721673831)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2803707174215673840)
,p_name=>'Event Data Changed: Show in Calendar'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803707623463673843)
,p_event_id=>wwv_flow_imp.id(2803707174215673840)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2803703122149673788)
,p_attribute_01=>'apex.event.trigger(this.affectedElements, "click");'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799601182216477838)
,p_name=>'Event selected: Copy to "My Sessions"'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7593273861783766592)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799601620339477843)
,p_event_id=>wwv_flow_imp.id(2799601182216477838)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799601241832477839)
,p_event_id=>wwv_flow_imp.id(2799601182216477838)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799601584119477842)
,p_event_id=>wwv_flow_imp.id(2799601182216477838)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799601770565477844)
,p_event_id=>wwv_flow_imp.id(2799601182216477838)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799601888370477845)
,p_name=>'Delete Selected Event'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2799601051570477837)
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602093536477847)
,p_event_id=>wwv_flow_imp.id(2799601888370477845)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602114058477848)
,p_event_id=>wwv_flow_imp.id(2799601888370477845)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602251258477849)
,p_event_id=>wwv_flow_imp.id(2799601888370477845)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602352342477850)
,p_event_id=>wwv_flow_imp.id(2799601888370477845)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799602501935477851)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602569477477852)
,p_event_id=>wwv_flow_imp.id(2799602501935477851)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602635758477853)
,p_event_id=>wwv_flow_imp.id(2799602501935477851)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799602776433477854)
,p_event_id=>wwv_flow_imp.id(2799602501935477851)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2799603466210477861)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2799603539809477862)
,p_event_id=>wwv_flow_imp.id(2799603466210477861)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(7593273861783766592)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2803751284556282415)
,p_name=>'Clear Schedule'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2803751113802282414)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803751402675282416)
,p_event_id=>wwv_flow_imp.id(2803751284556282415)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803751443476282417)
,p_event_id=>wwv_flow_imp.id(2803751284556282415)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803751530178282418)
,p_event_id=>wwv_flow_imp.id(2803751284556282415)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803751671291282419)
,p_event_id=>wwv_flow_imp.id(2803751284556282415)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2803751973835282422)
,p_name=>'Change topic'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803752024382282423)
,p_event_id=>wwv_flow_imp.id(2803751973835282422)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4109396660008965017)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4109396757459965018)
,p_event_id=>wwv_flow_imp.id(4109396660008965017)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2626488125547555675)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2626488237622555676)
,p_event_id=>wwv_flow_imp.id(2626488125547555675)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600766706477834)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6999177379873813221)
,p_plug_name=>'Calendar Styling'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(2799653457245040030)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600226373477829)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5260333213837940502)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5260334345647940508)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795850982643865323)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795851481997865329)
,p_event_id=>wwv_flow_imp.id(2795850982643865323)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5260334345647940508)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2799600372179477830)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6036368600954217268)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6036369732764217274)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2795857375059952190)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2795857824917952191)
,p_event_id=>wwv_flow_imp.id(2795857375059952190)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6036369732764217274)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10210745830207630551)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5144755302856213070)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10210745830207630551)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10210745942810630555)
,p_name=>'P101_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10210745830207630551)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10210746042536630555)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5261206593065172830)
,p_name=>'Set Focus'
,p_event_sequence=>10
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5261206914471172831)
,p_event_id=>wwv_flow_imp.id(5261206593065172830)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5261207094343172831)
,p_event_id=>wwv_flow_imp.id(5261206593065172830)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10210746317722630557)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10210746224626630556)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10210746519546630557)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10210746415228630557)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2810829420740326544)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7056949583807994336)
,p_plug_name=>'Custom Calendar Initialization'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(2857428741741246646)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2810829512103326545)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6870926546311706105)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6870927678121706111)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2857416164768109420)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(6870927678121706111)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2857416673577109420)
,p_event_id=>wwv_flow_imp.id(2857416164768109420)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6870927678121706111)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2857417064598109421)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2857417568487109421)
,p_event_id=>wwv_flow_imp.id(2857417064598109421)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2829667987280811104)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7752437343598346983)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7752438475408346989)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2955978497188130159)
,p_name=>'P112_DRAGDROP_MSG'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(7752438475408346989)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2955978051705130155)
,p_name=>'Begin Drag & Drop '
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7752438475408346989)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2955978208041130156)
,p_event_id=>wwv_flow_imp.id(2955978051705130155)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2955978225644130157)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2955978325044130158)
,p_event_id=>wwv_flow_imp.id(2955978225644130157)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2988198836917315114)
,p_event_id=>wwv_flow_imp.id(2955978225644130157)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2792962184403318064)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2792962881553318065)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2792963291407318066)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2792962881553318065)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2792962759096318065)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2792962881553318065)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2792962708318318065)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(2792962881553318065)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2792962556353318065)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(2792962881553318065)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792965671280318075)
,p_name=>'P301_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2792962184403318064)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792966072187318109)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792966357173318113)
,p_name=>'P301_TITLE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2792962184403318064)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792966796306318113)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792967153543318114)
,p_name=>'P301_SPEAKER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2792962184403318064)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792967523416318114)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792967995411318114)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2792968366797318115)
,p_name=>'P301_STATUS'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(2792962184403318064)
...
,p_named_lov=>'STATUS'
,p_lov=>'.'||wwv_flow_imp.id(2340272716587563659)||'.'
,p_field_template=>2526760615038828570
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2792963319908318066)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2792963291407318066)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2792964153756318069)
,p_event_id=>wwv_flow_imp.id(2792963319908318066)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2785879705183168944)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785879757951168945)
,p_event_id=>wwv_flow_imp.id(2785879705183168944)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2785879871671168946)
,p_event_id=>wwv_flow_imp.id(2785879705183168944)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2792969202905318121)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2792969567599318122)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2792969935340318122)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2792962759096318065)
,p_internal_uid=>775660993182322051
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2792970383053318122)
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(4582777617198789775)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(5359584000779871728)
,p_install_id=>wwv_flow_imp.id(4582777617198789775)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(4586699006452461522)
,p_install_id=>wwv_flow_imp.id(4582777617198789775)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(4586770391345466536)
,p_install_id=>wwv_flow_imp.id(4582777617198789775)
,p_name=>'insert data'
,p_sequence=>30
,p_script_type=>'INSTALL'
